...
[파이썬 웹 프로그래밍](http://www.yes24.com/Product/Goods/63503495)의 코드를 정리한 Repository입니다.  
책의 내용 및 코드의 저작권은 저자이신 **김석훈** 님에게 있음을 알려드립니다.
...
- [x] 2.2 웹 클라이언트 라이브러리
- [x] 2.3 웹 서버 라이브러리
- [x] 2.4 CGI/WSGI 라이브러리

### CHAPTER 03 Django 웹 프레임워크

- [x] 3.1 일반적인 특징
- [x] 3.2 장고 프로그램 설치
- [x] 3.3 장고에서의 애플리케이션 개발 방식
- [ ] 3.4 애플리케이션 설계하기
- [ ] 3.5 프로젝트 뼈대 만들기
